...
const Navbar = () => {
  ...
  return (
    <header>
      <nav className='max-w-screen-2x1 container mx-auto flex justify-between items-center py-6 px-12'>
         <Link to= "/" className='font-stretch-expanded'> RAJ FURNITURE </Link>

         {/* Desktop menu item */}
         <div className='md:flex lg:flex hidden items-center container sm:gap-4 md:gap-6 lg:gap-16'>
